...
function getSectionTemplate(section_id,section_name,section_parents) {
	...
	'<button type="button" style="font-size: 12px;" class="btn btn-default btn-xs" onclick="addSectionProcess('+section_id+')">Add Process</button>'+
	'<button type="button" style="font-size: 12px;" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" aria-expanded="false">'+
