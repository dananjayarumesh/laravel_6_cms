	...
	$('#addProcess').click(function(){
		...
		// $.each( sub_processes, function( index, row ){
			...
			if(exist_check <= -1){
				...
				hidden_input+
				'<input type="hidden" name="process_start[]"  value="'+start_date+'">'+
				'<input type="hidden" name="process_end[]"  value="'+end_date+'">'+
				'<input type="hidden" name="pro_type[]"  value="'+production_type+'">'+
				'<input type="hidden" name="pro_unit_price[]"  value="'+production_unit_price+'">'+
				...
				return notify.error('This process already exists.');
			}
		// });
...
// $('.sortable-'+main_process).html(output);
...
$('#addStock').click(function() {
	...
	if(exist_qty_exists){
		...
		'<input type="hidden" name="section_stocks_items['+main_process+'][]" value="'+item_id+'">'+
		'<input type="hidden" class="section-'+main_process+'-stock-'+item_id+'-qty" name="section_stock_qtys['+main_process+'][]" value="'+qty+'" id="used_stock_qty_'+item_id+'">'+
